-- init.sql — schema bootstrap for the PostgreSQL service (copied from Module 6).
--
...
-- time the named volume is initialised (i.e. on a clean EC2 host). The worker
-- also calls db.load_data.create_schema(), so the schema exists either way.
