...
def _parse_date(raw: str | None):
    """Parse 'Jun 02, 2026' → datetime.date, or return None."""
    if not raw:
        return None
...
def load_data(filepath: str = DATA_FILE) -> int:
    """Load JSON applicant data into PostgreSQL. Returns number of rows inserted."""
    ...
    inserted = sum(1 for r in rows if r["url"])
